...
<head>
    ...
    <title>Manajemen Jadwal | Open Library</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li><a href="{{ route('admin.jadwal.index') }}" class="active"><i class="fas fa-calendar-alt"></i><span>Jadwal</span></a></li>
    ...
    <div class="sidebar-footer">
        <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button type="submit" class="logout-btn" style="width: 100%; background: none; cursor: pointer;">
                <span>Keluar</span>
            </button>
        </form>
    </div>
